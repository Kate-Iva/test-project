    ...
    >
      {() => (
        <Form className={styles.flexBox}>
          <CardType label="Тип тренування:" name="trainingType" options={typeOptions}/>

          <CardType label="Розрядність:" name="trainingType" options={difficultiOptions}/>
         
          <div className={styles.timeOptionsBlock}>
          <CardType label="Запам/’ятати за:" name="trainingType" options={timeOptions}/>
          <CardType label="Згадати за:" name="trainingType" options={timeOptions}/>
         </div>
